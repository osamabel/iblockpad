...
export default function About() {
  return (
    <div className="w-[1128px] flex pt-[200px] gap-y-[40px] relative">
      ...
      <div className="flex flex-wrap relative border-2 w-full">
        <div className=" w-[50%] h-[200px] relative ">
          <div className="w-full absolute flex flex-col card pb-[20px] h-[250px]">
        ...
        <div className=" w-[50%] h-[200px] relative">
          <div className="w-full absolute flex flex-col card pb-[20px] h-[250px] top-[80px] right-[-30px]">
            <div className="h-[100px] w-full flex justify-start">
              <img className="" src="/section.svg" alt="" />
            </div>
            <p className="rtl font-light font-graphik-arabic px-[40px] leading-[30px]">
        ...
        <div className="w-[50%] h-[200px] relative">
          <div className="w-full absolute flex flex-col card pb-[20px] h-[250px] top-[90px] right-[100px]">
            <div className="h-[100px] w-full flex justify-start">
              <img className="" src="/section.svg" alt="" />
            </div>
            <p className="rtl font-light font-graphik-arabic px-[40px] leading-[30px]">
